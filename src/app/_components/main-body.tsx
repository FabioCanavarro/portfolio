        ...
        >
          ...
          <section className="text-center mb-20">
            ...
            <motion.div 
              ...
              variants={itemVariants}
            >
              <Link href="https://github.com/FabioCanavarro" target="_blank" rel="noopener noreferrer" className="text-subtext1 hover:text-mauve transition-colors duration-300">
                <Github size={28} />
              </Link>
              <Link href="https://www.linkedin.com/in/fabio-canavarro-584b232a7/" target="_blank" rel="noopener noreferrer" className="text-subtext1 hover:text-blue transition-colors duration-300">
                <Linkedin size={28} />
              </Link>
              <Link href="mailto:fabiocanavarrotoh@gmail.com" className="text-subtext1 hover:text-rosewater transition-colors duration-300">
                <Mail size={28} />
              </Link>
            </motion.div>
          </section>
              ...
              {projects.map((project, index) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <Link href={project.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-rosewater hover:text-flamingo transition-colors duration-300 group">
                      View on GitHub
                      <ExternalLink className="w-4 h-4 ml-1.5 transition-transform duration-300 group-hover:translate-x-1" />
                    </Link>
                  </div>
             ...
             <div className="space-y-4">
                {contributions.map((contrib, index) => (
                     <motion.div 
                      ...
                      >
                        <Link href={contrib.link} target="_blank" rel="noopener noreferrer" className="group">
