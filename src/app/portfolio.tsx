...
const jsonLd = {
  ...
  sameAs: [
    'https://github.com/FabioCanavarro',
  ],
  ...
  description: "A 16-year-old software developer specializing in Rust, systems programming, and building foundational technologies.",
  alumniOf: "Hackclub" 
};
